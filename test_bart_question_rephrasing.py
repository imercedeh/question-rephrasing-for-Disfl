...
model_checkpoint = root+"Models\\BART"

test_model=DisfluencyCorrectorTester(model_checkpoint,32)

test_model.evaluate(train_path,results_path+"mybart7-train")

test_model.evaluate(dev_path,results_path+"mybart7-dev")

test_model.evaluate(test_path,results_path+"mybart7-test")
